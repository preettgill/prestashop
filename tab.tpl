...
<ul class="nav nav-tabs tab-info page-product-heading">
	...
	{if $product->description}
		<li class="active"><a href="#tab2" data-toggle="tab">{l s='Description'}</a></li>
	{/if}
	{if isset($features) && $features}
		<li><a href="#tab3" data-toggle="tab">{l s='Specifications'}</a></li>
	{/if}
    
    {if $manufact_name}
		<li><a href="#tabM" data-toggle="tab">{l s='Designer Info'}</a></li>
	{/if}
	...
	{if isset($accessories) && $accessories}
		<li><a href="#tab4" data-toggle="tab">{l s='Match with'}</a></li>
	{/if}			
...
{if $manufact_name}
	<!-- More info -->
	<section id="tabM" class="tab-pane page-product-box">   
      {*  {if isset($product_manufacturer->id)}
                <a href="{$link->getManufacturerLink($product_manufacturer->id_manufacturer, $product_manufacturer->link_rewrite)|escape:'html':'UTF-8'}"><img src="{$img_manu_dir}{$product_manufacturer->id}-medium_default.jpg"  title="View more from {$product_manufacturer->name} "/></a>
            {/if}    *}
              <!--    <img src="{$img_manu_dir}{$product_manufacturer->id}-medium_default.jpg"  title="View more from {$product_manufacturer->name} "/>-->
               	
                <img src="{$img_manu_dir}{$product_manufacturer->id}-manufac.jpg"  title="View more from {$product_manufacturer->name} "/>
                <div style = "margin-top:20px;">
        <h3 class = "tabM-name">{$manufact_name}</h3>
        <p>{$manufact_shortdesc}</p> 
<p>{$manufact_desc}</p>
<a href="{$link->getmanufacturerLink($product->id_manufacturer, $product->link_rewrite)}"><button class = "btn">View all products from {$product->manufacturer_name|escape:'htmlall':'UTF-8'}</button></a></div>
			<!-- full description -->
										...
										<div class="product-image-container image ">
											...
											<div class="box-buttons">
												...
												{if isset($comparator_max_item) && $comparator_max_item}
													<a class="add_to_compare compare button btn" href="{$accessory.link|escape:'html':'UTF-8'}" data-id-product="{$accessory.id_product}" title="{l s='Add to compare'}">
														<span><i class="fa fa-refresh"></i></span>
													</a>
												{/if}
												
												{if isset($quick_view) && $quick_view}
													<a class="quick-view" href="{$accessory.link|escape:'html':'UTF-8'}" data-link="{$accessory.link|escape:'html':'UTF-8'}" data-original-title="{l s='Quick view'}">
